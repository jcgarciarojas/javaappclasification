...
import edu.umd.msswe.ece591.diagnose.metrics.NOC;
...
public class JUnitTestNOC extends TestCase {
	...
	public static String getJavaClassesList(String className) throws ConfigurationException
	{
		...
		"    private class ChildClass1 extends "+className+"{}\n"+
		"}";
	}
